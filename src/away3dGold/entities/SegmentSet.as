package away3dGold.entities
{
	import away3dGold.arcane;
	import away3dGold.animators.IAnimator;
	import away3dGold.bounds.BoundingSphere;
	...
	import away3dGold.core.partition.RenderableNode;
	import away3dGold.materials.MaterialBase;
	import away3dGold.materials.SegmentMaterial;
	import away3dGold.primitives.LineSegment;
	import away3dGold.primitives.data.Segment;
	...
	public class SegmentSet extends Entity implements IRenderable
	{
		...
		*/
		...
		{
			var segRef:SegRef;
			if(index >= _indexSegments ) return;
			...
			var subSet:SubSet;
			if(!_subSets[segRef.subSetIndex]) return;
		...
		*/
		public function removeAllSegments() : void
		{
			...
			for(var i:uint = 0;i<_subSetCount;++i){
				...
				subSet.indices = null;
				if(subSet.vertexBuffer) subSet.vertexBuffer.dispose();
