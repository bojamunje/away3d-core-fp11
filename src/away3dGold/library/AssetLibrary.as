package away3dGold.library
{
	...
	public class AssetLibrary
	{
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.conflictStrategy
		*/
		 ...
		 *
		 * @see away3dGold.library.AssetLibraryBundle.conflictPrecedence
		*/
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.createIterator()
		*/
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.load()
		 */
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.loadData()
		 */
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.getAsset()
		 */
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.addAsset()
		*/
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.removeAsset()
		*/
		 ...
		 * @param dispose Defines whether the assets should also be disposed.
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.removeAssetByName()
		*/
		 ...
		 * @param dispose Defines whether the assets should also be disposed.
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.removeAllAssets()
		*/
		 ...
		 * 
		 * @see away3dGold.library.AssetLibraryBundle.removeNamespaceAssets()
		*/
