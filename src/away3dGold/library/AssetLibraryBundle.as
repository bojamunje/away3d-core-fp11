package away3dGold.library
{
	...
	import away3dGold.loaders.misc.SingleFileLoader;
	import away3dGold.loaders.parsers.ParserBase;
	 ...
	 * 
	 * @eventType away3dGold.events.LoaderEvent
	 */
	[Event(name="resourceComplete", type="away3dGold.events.LoaderEvent")]
	 ...
	 * @eventType away3dGold.events.LoaderEvent
	 */
	[Event(name="dependencyComplete", type="away3dGold.events.LoaderEvent")]
	 ...
	 * @eventType away3dGold.events.LoaderEvent
	 */
	[Event(name="loadError", type="away3dGold.events.LoaderEvent")]
	
	/**
	 * Dispatched when any asset finishes parsing. Also see specific events for each
	 * individual asset type (meshes, materials et c.)
	 * 
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="assetComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="geometryComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="skeletonComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="skeletonPoseComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="containerComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="animationSetComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="animationStateComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="animationNodeComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="stateTransitionComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="textureComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="materialComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="animatorComplete", type="away3dGold.events.AssetEvent")]
	 ...
	 * @eventType away3dGold.events.AssetEvent
	 */
	[Event(name="textureSizeError", type="away3dGold.events.AssetEvent")]
	...
	public class AssetLibraryBundle extends EventDispatcher
	{
		 ...
		 * be renamed.
		 * 
		 * @see away3dGold.library.naming.ConflictStrategy
		 * @see away3dGold.library.AssetLibrary.conflictPrecedence
		*/
		 ...
		 * 
		 * @see away3dGold.library.naming.ConflictPrecedence
		 * @see away3dGold.library.naming.ConflictStrategy
		*/
		 ...
		 * 
		 * @see away3dGold.library.assets.AssetType
		 */
		 ...
		 * @param dispose Defines whether the assets should also be disposed.
		 * 
		 * @see away3dGold.library.AssetLibrary.removeAsset()
		 */
