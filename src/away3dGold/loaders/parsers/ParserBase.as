package away3dGold.loaders.parsers {
	 ...
	 * 
	 * @eventType away3dGold.events.ParserEvent
	 */
	[Event(name="parseComplete", type="away3dGold.events.ParserEvent")]
	 ...
	 * @eventType away3dGold.events.ParserEvent
	 */
	[Event(name="readyForDependencies", type="away3dGold.events.ParserEvent")]
	 ...
	 * @eventType away3dGold.events.ParserEvent
	 */
	[Event(name="parseError", type="away3dGold.events.ParserEvent")]
	 ...
	 *
	 * @see away3dGold.loading.parsers.AssetLoader
	 * @see away3dGold.loading.ResourceManager
	 */
	public class ParserBase extends EventDispatcher
	{
		 ...
		 *
		 * @see away3dGold.loading.parsers.ParserDataFormat
		 */
