package away3dGold.animators.nodes
{
	...
	import away3dGold.animators.data.ParticleProperties;
	import away3dGold.animators.ParticleAnimationSet;
	...
	public class ParticleNodeBase extends AnimationNodeBase
	{
		 ...
		 * 
		 * @see away3dGold.animators.data.ParticlePropertiesMode
		 */
		 ...
		 * 
		 * @see away3dGold.animators.ParticleAnimationSet
		 ...
		 * 
		 * @see away3dGold.animators.ParticleAnimationSet#initParticleFunc
		 */
