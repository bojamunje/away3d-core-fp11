package away3dGold.animators
{
	 ...
	 *
	 * @eventType away3dGold.events.AnimatorEvent
	 */
	[Event(name="start",type="away3dGold.events.AnimatorEvent")]
	 ...
	 * @eventType away3dGold.events.AnimatorEvent
	 */
	[Event(name="stop",type="away3dGold.events.AnimatorEvent")]
	 ...
	 * @eventType away3dGold.events.AnimatorEvent
	 */
	[Event(name="cycle_complete",type="away3dGold.events.AnimatorEvent")]
	...
	public class AnimatorBase extends NamedAssetBase implements IAsset
	{
		 ...
		 * 
		 * @see away3dGold.animators.states.IAnimationState#positionDelta
		 */
