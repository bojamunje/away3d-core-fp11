...
import away3dGold.arcane;
	...
	import away3dGold.core.pick.PickingCollisionVO;
	import away3dGold.core.pick.PickingType;
	import away3dGold.events.TouchEvent3D;
		...
		public function fireTouchEvents():void {
			...
			for( i = 0; i < _numTouchPoints; ++i ) {
				...
				if( _collidingObject != _previousCollidingObject ) {
					if( _previousCollidingObject ) queueDispatch( TouchEvent3D.TOUCH_OUT, _touchMoveEvent, _previousCollidingObject, _touchPoint );
					if( _collidingObject ) queueDispatch( TouchEvent3D.TOUCH_OVER, _touchMoveEvent, _collidingObject, _touchPoint );
				}
