package away3dGold.core.render
{
	import away3dGold.arcane;
	import away3dGold.core.managers.Stage3DProxy;
	import away3dGold.core.sort.IEntitySorter;
	import away3dGold.core.sort.RenderableMergeSort;
	...
	public class RendererBase
	{
		...
		protected function executeRender(entityCollector : EntityCollector, target : TextureBase = null, scissorRect : Rectangle = null, surfaceSelector : int = 0) : void
		{
			...
			//line required for correct rendering when using away3dGold with starling. DO NOT REMOVE UNLESS STARLING INTEGRATION IS RETESTED!
