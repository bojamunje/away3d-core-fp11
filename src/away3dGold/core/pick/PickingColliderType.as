package away3dGold.core.pick
{
	/**
	 * Options for setting a picking collider for entity objects. Used with the <code>RaycastPicker</code> picking object.
	 * 
	 * @see away3dGold.entities.Entity#pickingCollider
	 * @see away3dGold.core.pick.RaycastPicker
	 */
	public class PickingColliderType
	{
		 ...
		 * 
		 * @see away3dGold.core.pick.AS3PickingCollider
		 */
		 ...
		 * 
		 * @see away3dGold.core.pick.PBPickingCollider
		 */
		 ...
		 * 
		 * @see away3dGold.core.pick.AutoPickingCollider
		 * @see away3dGold.core.pick.AutoPickingCollider#triangleThreshold
		 */
